		...
		<tr>
			...
			<td valign="top">
				...
				<div style="margin: 50px;">				
					...
					<form action='<c:url value="/FormServlet?op=editUserInfo" />' name="form" enctype="multipart/form-data">
			...
			<td valign="top" >			
				...
				<div style="margin: 50px;">
					...
					<form action='<c:url value="/FormServlet?op=updatePwd" />' name="updatePwd" enctype="application/x-www-form-urlencoded" >
