		...
		<tr>
			...
			<td valign="top">
				...
				<div style="margin: 50px;">				
					...
					<form action='<c:url value="/AdUpdateServlet?op=updateUserInfo" />' name="form" enctype="multipart/form-data">
			...
			<td valign="top" >			
				...
				<div style="margin: 50px;">
					...
					<form action='<c:url value="/AdUpdateServlet?op=updateUserPwd&userName=${ userInfoBean.userInfo.userName }" />' name="updatePwd" enctype="application/x-www-form-urlencoded" >
